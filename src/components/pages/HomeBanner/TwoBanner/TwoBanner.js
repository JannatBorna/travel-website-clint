            ...
            <Container>
                ...
                <div className="middle-div">
                    <div className="text-start">
                       <h5 className='font-semibold text-white'>PROD<span className="theme-color">UCT INFORMATION</span></h5>
                    ...
                    <div className="text-start">
                       <h5 className='font-semibold text-white'>TRA<span className="theme-color">INING RESOURCES</span></h5>
                    ...
                    <div className="text-start">
                       <h5 className='font-semibold text-white'>TRA<span className="theme-color">VEL GUIDES</span></h5>
